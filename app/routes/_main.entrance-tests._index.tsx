                        ...
                        {(account) => account?.status === 0 ? (
                            <Suspense fallback={<LoadingSkeleton />}>
                                <Await resolve={loaderData.promise}>
                                    {
                                        (result) => {
                                            const entranceTest = result.data as EntranceTest[]
                                            const page = Number.parseInt(result.headers["X-Page"] || "1")
                                            const totalPages = Number.parseInt(result.headers["X-Total-Pages"] || "1")
                                            return (
                                                <>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="rounded-b-lg p-4">
                                                                        <ul className="space-y-2 text-gray-700">
                                                                            ...
                                                                            <li>
                                                                                <span className="font-semibold">Ca thi:</span> {entranceTest.shift + 1} ({SHIFT_TIME[entranceTest.shift]})
                                                                            </li>
                                                                            <li>
